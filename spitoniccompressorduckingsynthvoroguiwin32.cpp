...
#include "stdafx.h"
#include "spitoniccompressorduckingsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitoniccompressorduckingsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniccompressorduckingsynthvoroguiwin32class"};				// the main window class name
